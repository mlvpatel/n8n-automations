...
| Workflow | Key integrations | Nodes |
|---|---|:--:|
| [LinkedIn Lead Scraping with HorizonDataWave](workflows/sales-crm/linkedin-lead-scraping-horizondatawave.json) | Google Sheets, Hdw Linkedin, Hdw Linkedin Management, Hdw Web Parser Tool | 93 |
| [LinkedIn Leads Scraping & Enrichment](workflows/sales-crm/linkedin-leads-scraping-enrichment.json) | Google Sheets, Google Sheets Trigger | 66 |
